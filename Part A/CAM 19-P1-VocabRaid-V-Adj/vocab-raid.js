...
const VOCAB = [
...

  {
    word: "cover",
    phonetic: "/ˈkʌvə(r)/",
    scenario: "You cannot see the road because water covers it.",
    meaning: "To put something over something else.",
    vi: "che phủ",
    emoji: "🌊"
  },
  {
    ...
    scenario: "Many fish disappear when the water is polluted.",
    meaning: "To go away or cannot be seen anymore.",
    vi: "biến mất",
    emoji: "💨"
  },
  {
    word: "convert",
    phonetic: "/kənˈvɜːt/",
    scenario: "People convert wetlands into farms.",
  ...
  },
  {
    word: "destroy",
    phonetic: "/dɪˈstrɔɪ/",
    scenario: "Construction can destroy natural habitats.",
  ...
  },
  {
    word: "remain",
    phonetic: "/rɪˈmeɪn/",
    scenario: "Some wetlands still remain today. Others are gone.",
    meaning: "To still exist or stay.",
    vi: "còn lại",
    emoji: "⏳"
  },
...

  {
    word: "present",
    phonetic: "/ˈpreznt/",
    scenario: "Many animals are still present in this wetland.",
    meaning: "Existing or being in a place.",
    vi: "hiện diện",
    emoji: "📍"
  },
  {
    word: "complex",
    phonetic: "/ˈkɒmpleks/",
    scenario: "An ecosystem is very complex. Many plants and animals live together.",
    meaning: "Having many parts and not simple.",
    vi: "phức tạp",
    emoji: "🧩"
  },
  {
    word: "unique",
    phonetic: "/juˈniːk/",
    scenario: "This wetland is unique. You cannot find another one like it.",
    meaning: "Very special and different from others.",
    vi: "độc đáo",
    emoji: "✨"
  },
  {
    word: "commercial",
    phonetic: "/kəˈmɜːʃl/",
    scenario: "This land is used for commercial buildings with many shops and offices.",
    meaning: "Related to business and making money.",
    vi: "thuộc thương mại",
    emoji: "🏬"
  },
  {
    ...
    scenario: "This area is agricultural. Farmers grow rice and vegetables here.",
  ...
  },
  {
    ...
    scenario: "This is an industrial area. There are many factories.",
    meaning: "Related to factories and industry.",
