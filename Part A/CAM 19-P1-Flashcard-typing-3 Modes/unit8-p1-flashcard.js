// ════════════════════════════════════════════════════════
// FILE: unit8-p1-flashcard.js  —  LOGIC ỨNG DỤNG
// ════════════════════════════════════════════════════════
// Nhiệm vụ: Toàn bộ logic của flashcard — state, render,
//           3 chế độ học (Easy / Medium / Hard), TTS,
//           hint system, và hệ thống XP & streak.
//
// File này KHÔNG chứa dữ liệu bài học.
// Dữ liệu (allCards, CATS, LESSON_INFO) được load từ
// unit8-p1-data.js — file đó phải được load TRƯỚC file này.
//
// Khi đổi bài học: chỉ sửa unit8-p1-data.js.
