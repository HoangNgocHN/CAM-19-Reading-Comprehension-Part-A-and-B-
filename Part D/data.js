    ...
    levels: {
      ...
      3: {
        questions: [
          {
            id: 1,
            text: "Peatlands are wetlands that contain layers of waterlogged organic soil.",
            answer: "TRUE",
            explanation: "The passage defines peatlands as 'wetlands with a waterlogged organic soil layer.'",
            highlight: [17, 25],
          },
          {
            id: 2,
            text: "The drainage of peatlands reduces global carbon emissions by six percent.",
            answer: "FALSE",
            explanation: "The passage says draining peatlands 'causes' (not reduces) six per cent of all global carbon emissions.",
            highlight: [57, 67],
          },
          {
            id: 3,
            text: "Planting oil palm trees on peatlands leads to an increase in the risk of forest fires.",
            answer: "TRUE",
            explanation: "'The clearance of peatlands for planting also increases the risk of forest fires' — and palm oil is named as one of the in-demand commodities driving this clearance.",
            highlight: [68, 80],
          },
          {
            id: 4,
            text: "Marcel Silvius claims that peatland forests are being destroyed for long-term economic gain.",
            answer: "FALSE",
            explanation: "Silvius describes the loss as being 'for a few decades of oil palm revenues' — that is short-term gain, not long-term.",
            highlight: [87, 108],
          },
          {
            id: 5,
            text: "Wetlands used for cultivating palm oil are more biodiverse than those used for pulpwood production.",
            answer: "NOT GIVEN",
            explanation: "Palm oil and pulpwood are both mentioned as in-demand commodities, but the passage does not compare the biodiversity of the wetlands used for each.",
            highlight: [11, 16],
          },
          {
            id: 6,
            text: "The clearance of peatlands for cultivation is the main source of global carbon emissions.",
            answer: "FALSE",
            explanation: "The passage states the practice causes 'six per cent' of all global carbon emissions — a significant share, but not the main source.",
            highlight: [57, 67],
          },
        ],
      },
